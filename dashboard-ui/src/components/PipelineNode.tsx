  ...
  return (
    <group position={position}>
      ...
      {isVisible && !isScorecard && (
        <Html position={[0, -(r + 0.8), 0]} center distanceFactor={28} style={{ pointerEvents: 'none' }}>
      ...
      {isTrigger && showClickHint && (
        <Html position={[0, -2.5, 0]} center distanceFactor={28}>
      ...
      {isVisible && !isTrigger && !isScorecard && branches.map(b => {
        ...
        return (
          <group key={b.id}>
            ...
            {isExp && (
              <Html position={[off[0], off[1] + 1.2, off[2]]} center distanceFactor={28} style={{ pointerEvents: 'none' }}>
      ...
      {isScorecard && isVisible && (
        <Html position={[r + 1, 0, 0]} distanceFactor={28} style={{ pointerEvents: 'none', transform: 'translate3d(0, -50%, 0)' }}>
